# YoungCapital Front-End Candidate Challenge

![screenshot](screenshot.png "screenshot")

You can access this project on Zeplin [here](http://zpl.io/25e1Jmj).

## Tasks

- 1. Build a static version of the site first, using React, CSS and hardcoded fixture data

[OPTIONAL]
- 2. Make an AJAX call to `/playlist.json` to get the playlist
- 3. Iterate over the JSON to display the playlist
- 4. Set up play controls to display the correct track and album art (and highlight the currently playing track in the playlist) when you:
  - 4.1 skip tracks using the player controls
  - 4.2 click a track in the playlist

## Extra files

- `/public/fonts` contains the fonts
- `/public/icons` contains the icons
- `/public/img` contains the images for the playlist
